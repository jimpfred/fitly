...
class UserProfile(models.Model):
    ...
    current_blood_sugar = models.IntegerField()
...
class Elog(models.Model):
    ...
    length_of_time_minutes = models.IntegerField(null=True, blank=True)
    reps_laps = models.IntegerField(null=True, blank=True)  
    weight_pounds = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True) # for resistant training
    intensity = models.IntegerField(null=True, blank=True) # 1 - 5
    pace_minutes_per_mile = models.IntegerField(null=True, blank=True)
